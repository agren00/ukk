        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                <i class="ri-account-circle-line"  style="font-size: 50px;"></i>
              <h2>{{ Auth::user()->name }}</h2>
              <div class="social-links mt-2">
                <a href="https://github.com/agren00/projectagren" class="github"> <i class="bi bi-github"></i></a>
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">proposal</button>
                </li>
